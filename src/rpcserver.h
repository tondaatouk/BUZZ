...
extern json_spirit::Value autobackupwalletenabled(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getautobackupwalletenabled(const json_spirit::Array& params, bool fHelp);
